#!/usr/bin/env python3
"""
🚀 MORDZIX AI - SSH DEPLOYMENT via Python OS Commands
"""
import os
import sys
import time
...
echo ''
echo '🌐 LIVE: http://162.19.220.29:8080/'
"""
...
def main():
    print("╔════════════════════════════════════════════════════════════╗")
    print("║  🚀 MORDZIX AI DEPLOYMENT - PYTHON SSH 🚀                ║")
    print("╚════════════════════════════════════════════════════════════╝")
    print()
    ...
    if system == "windows":
        ...
        print("💡 Creating batch file with SSH commands...")
        ...
        print(f"📜 Commands written to {bat_path}")
        print("⚠️ Please run this batch file manually.")
        print(f"   You'll need to enter password: {PASSWORD}")
        print()
        print("📋 OR copy-paste these commands:")
        print()
        ...
        if os.system("which sshpass >/dev/null 2>&1") == 0:
            ...
            print("🔑 Using expect script for authentication")
            script_path = generate_expect_script()
            run_cmd(script_path)
        else:
            print("⚠️ Neither sshpass nor expect found")
